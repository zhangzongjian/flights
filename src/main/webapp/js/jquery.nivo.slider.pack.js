...
slider.append($('<div class="nivo-caption"></div>').css({right:'-800'}));if(vars.currentImage.attr('title')!=''){var title=vars.currentImage.attr('title');if(title.substr(0,1)=='#')title=$(title).html();$('.nivo-caption',slider).html(title);$('.nivo-caption',slider).animate({right:'24'},400);}
...
if(vars.currentImage.attr('title')!=''){var title=vars.currentImage.attr('title');if(title.substr(0,1)=='#')title=$(title).html();if($('.nivo-caption',slider).css('display')=='block'){$('.nivo-caption',slider).animate({right:'-800'},400,function(){$(this).html(title);});}else{$('.nivo-caption',slider).html(title);}
$('.nivo-caption',slider);}else{}

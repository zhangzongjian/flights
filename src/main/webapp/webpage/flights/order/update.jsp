...
<body>
    ...
    <form action="${contextPath}/order/update">
	    ...
	    <ul class="forminfo">
	  	...
	  	<li><label>预定时间</label><input name="orderTime" type="text" class="dfinput" value="<fmt:formatDate value="${order.orderTime }" pattern="yyyy-MM-dd HH:mm" />"/></li>
	  	...
	  	<li><label>创建时间</label><input name="createTime" type="text" class="dfinput" value="<fmt:formatDate value="${order.createTime }" pattern="yyyy-MM-dd HH:mm" />"/></li>

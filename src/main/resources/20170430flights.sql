...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', '1102349546@qq.com', '15622385135', null, 'Jack', '坚', 'abc', '1996-12-25', '男', '34654651', null);
...
-- Records of order
-- ----------------------------
INSERT INTO `order` VALUES ('1', '1493401455843', null, '4', null, '我', '2048092', '未付款', '1', '2017-04-29 01:44:15');
INSERT INTO `order` VALUES ('2', '1493452138333', null, '2', '2017-04-29 15:48:58', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 15:48:58');
INSERT INTO `order` VALUES ('3', '1493452321936', null, '2', '2017-04-29 15:52:01', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 15:52:01');
INSERT INTO `order` VALUES ('4', '1493453498670', null, '2', '2017-04-29 16:11:38', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 16:11:38');
INSERT INTO `order` VALUES ('5', '1493453690255', null, '2', '2017-04-29 16:14:50', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 16:14:50');
INSERT INTO `order` VALUES ('6', '1493453945885', null, '2', '2017-04-29 16:19:05', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 16:19:05');
INSERT INTO `order` VALUES ('7', '1493454344789', null, '2', '2017-04-29 16:25:44', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 16:25:44');
INSERT INTO `order` VALUES ('8', '1493454460972', null, '2', '2017-04-29 16:27:40', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 16:27:40');
INSERT INTO `order` VALUES ('9', '1493454496179', null, '2', '2017-04-29 16:28:16', '张宗坚', '2049925235', '未付款', '1', '2017-04-29 16:28:16');
INSERT INTO `order` VALUES ('10', '1493454631265', null, '2', '2017-04-29 16:30:31', '高的', '245642', '未付款', '1', '2017-04-29 16:30:31');
...
INSERT INTO `order_passenger` VALUES ('20', '10', '19');
...
INSERT INTO `passenger` VALUES ('19', '阿斯蒂芬', '2452', null, '23524', '1');
...
-- Records of plane
-- ----------------------------
INSERT INTO `plane` VALUES ('1', '737-800', '波音', '13', null, null, null, '2017-04-25 22:28');
...
-- ----------------------------
-- Procedure structure for get_flight_detail
-- ----------------------------
DROP PROCEDURE IF EXISTS `get_flight_detail`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_flight_detail`(`flightno` varchar(100), `starttime` varchar(100))
BEGIN	
...
AND TO_DAYS(flight.starttime) = TO_DAYS(@startTime);
...
-- ----------------------------
-- Procedure structure for get_order_detail
-- ----------------------------
DROP PROCEDURE IF EXISTS `get_order_detail`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_order_detail`(`orderid` int)
BEGIN
	SET @orderid = orderid;   
	SELECT
`order`.id,
...
`order`.ticketpriceid = ticketprice_detail.id AND
`order`.customerid = customer.id AND
ticketprice_detail.flightid = flight_detail.flightid AND
`order`.id = @orderid;
...
-- ----------------------------
-- Procedure structure for search_flights
-- ----------------------------
DROP PROCEDURE IF EXISTS `search_flights`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `search_flights`(IN startCity varchar(10), IN arrivalCity varchar(10), IN startTime varchar(100))
BEGIN  
...
AND company.id = company_plane.companyid
AND plane.id = company_plane.planeid
AND startAirport.airportcity = @startCity
AND arrivalAirport.airportcity = @arrivalCity
AND TO_DAYS(flight.starttime) = TO_DAYS(@startTime);

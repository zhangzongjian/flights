...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', '2452', '24523', '4235', '2452', '232', '25423', '23542', '245', '2352', '2452');
...
-- Records of flight
-- ----------------------------
INSERT INTO `flight` VALUES ('1', 'AQ1037', '2017-04-27 22:35:00', '1339', '2017-05-04 22:35:00', '1353', '1', null, null, '', '2017-04-25 22:44:00');
INSERT INTO `flight` VALUES ('2', 'BQ1037', '2017-04-27 00:19:09', '1339', '2017-04-29 00:19:14', '1353', '1', null, null, null, '2017-04-25 00:19:32');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost`  VIEW `order_detail` AS SELECT
`order`.orderno,
`order`.ordertime,
`order`.person,
`order`.phone,
...
passenger.mobilephone as p_mobilephone
FROM
`order` ,
flight_detail ,
customer ,
...
`order`.id = order_passenger.orderid AND
passenger.id = order_passenger.passengerid ;
...
ticketprice_detail.flightid = flight_detail.flightid AND
`order`.id = order_passenger.orderid AND
passenger.id = order_passenger.passengerid AND
`order`.id = @orderid;
